        ...
        foreach($_POST as $afb_p_key => $afb_p_value) {
	        ...
	        if(is_array($afb_form_fields[$afb_p_key]['type']['checkboxes'])) {
                ...
                foreach($afb_p_value as $chckValue) {
                    $chckValues .= $afb_form_fields[$afb_p_key]['type']['checkboxes'][$chckValue].', ';
                }
	        ...
	        # For Radios
		        ...
		        $replacement = $afb_form_fields[$afb_p_key]['type']['radios'][$afb_p_value];	
    
	        # For Selects (Multiple)
	        } else if($afb_form_fields[$afb_p_key]['multiple'] == 1) {
